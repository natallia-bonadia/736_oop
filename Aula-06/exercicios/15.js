// 15. Construa uma classe Veiculo que tem como propriedades rodas (1 a n), usaCombustivel (true/false) e crie uma classe Carro (tipoDecombustivel: 'gasolina', 'álcool', 'flex') e bicicleta (infantil: true/false - tem que ter mais que 2 rodas).
